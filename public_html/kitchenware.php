...
<html>
	<head>
		...
		<title>Annie's Antiques - Kitchenware</title>
	</head>
	<body>
	<header>
		<section>
	...
	<main class="stock">
		<ul class="categories">
			...
			<li class="current"><a href="furniture.php">Furniture</a></li>
		...
		<img src="images/kitchenware.jpg" alt="Kitchenware" />
<?php
$pdo = new PDO('mysql:dbname=antiques;host=127.0.0.1', 'student', 'student');

$products = $pdo->query('SELECT * FROM stock WHERE categoryId = 3');
